...
//mixed array
let input = ["sneha",1234567890,21,"abc@gmail.com",[98,89,90,98,100] ]
console.log(input)
...
console.log(input.unshift("sneha")) //5
console.log(input)
...
input.splice(2,1,"vfdhgeol") //splice(startindex,length,value to be inderted)
console.log(input)
////replcae element using splice without deleting element
input.splice(2,0,"vfdhgeol") //splice(startindex,length,value to be inderted)
console.log(input)
...
let personal_details=["sneha",21,"abc@email.com"]
